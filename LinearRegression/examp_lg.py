...
Original file is located at
    https://colab.research.google.com/drive/1Yna7iqFHn8xh1Vo4dPiM7C40aPCEeRXT
"""
...
#훈련데이터 생성
#x 데이터 - 문제 - 독립변수
x = np.array([[12],[14],[27],[36],[48],[72],[96],[100]])
#y 데이터 - 라벨 - 타겟변수 - 종속변수
...
#x, y 데이터의 전처리 수행
#x데이터를 정규분포로 표준화 수행, 데이터들의 변차가 심할경우와 너무 큰수는 모델이 훈련하여 가중치 정착에 에로사항이 있다.
x_mean = np.mean(x) # xdata의 평균
x_std = np.std(x) # xdata의 표준편차

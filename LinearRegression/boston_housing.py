# -*- coding: utf-8 -*-
"""02.19_linerarRegression_boston.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17M7jmPxk6KxXPPlNC7OtR8HADpiXWi_t
"""
...
plt.subplot(7,2,13)
plt.title("12")
plt.scatter(x_train[:,12],y_train,s=10)
plt.show()
...
modle.add(Input((2,)))
modle.add(Dense(1))
modle.compile(loss="NSE",optimizer="SGD")
modle.compile(loss="MSE",optimizer="SGD")

fhist = modle.fit(x_data,y_data,epochs=10)
...
print("오차확률의 평균의 ±%.2f"%(np.abs(err_mean)))